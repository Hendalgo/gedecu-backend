    ...
    public function run(): void
    {
        $reportTypes = [
            [
                ...
                'country' => 0,
                'meta_data' => '{"all":[{"name":"supplier_id","validation":"required|exists:users,id|user_role:4"},{"name":"account_id","validation":"required|exists:banks_accounts,id|bank_account_owner"},{"name":"amount","validation":"required|numeric"},{"name":"currency_id","validation":"required|exists:currencies,id"},{"name":"reference","validation":"required"},{"name":"isDuplicated","validation":"required|boolean|in:0"}],"name":"Proovedor"}'
            ],
            [
                'id' => 2,
                'name' => 'Ayuda recibida',
                ...
                'updated_at' => '2023-11-09 06:21:08',
                'country' => 0,
                'meta_data' => '{"all":[{"name":"user_id","validation":"required|exists:users,id|user_role:2"},{"name":"account_id","validation":"required|exists:banks_accounts,id|bank_account_owner"},{"name":"amount","validation":"required|numeric"},{"name":"reference","validation":"required"},{"name":"isDuplicated","validation":"required|boolean|in:0"}],"name":"Ayuda recibida venezuela"}'
            ],
            [
                'id' => 3,
                'name' => 'Billetera',
                ...
                'updated_at' => '2023-11-09 06:21:08',
                'country' => 0,
                'meta_data' => '{"all":[{"name":"account_id","validation":"required|exists:banks_accounts,id|bank_account_owner"},{"name":"transferences_quantity","validation":"required|numeric"},{"name":"amount","validation":"required|numeric"},{"name":"currency_id","validation":"required|exists:currencies,id"},{"name":"isDuplicated","validation":"required|boolean|in:0"}],"name":"Billetera"}'
            ],
            [
                'id' => 4,
                'name' => 'Local',
            ...
            [
                ...
                'updated_at' => '2023-11-09 06:21:08',
                'country' => 0,
                'meta_data' => '{"all":[{"name":"user_id","validation":"required|exists:users,id|user_role:2"},{"name":"account_id","validation":"required|exists:banks_accounts,id|bank_account_owner"},{"name":"amount","validation":"required|numeric"},{"name":"isDuplicated","validation":"required|boolean|in:0"}],"name":"Ayuda Realizada"}'
            ],
            [
                'id' => 7,
                'name' => 'Traspasos',
                ...
                'updated_at' => '2023-11-09 06:21:08',
                'country' => 0,
                'meta_data' => '{"all":[{"name":"senderAccount_id","validation":"required|exists:banks_accounts,id|bank_account_owner"},{"name":"receiverAccount_id","validation":"required|exists:banks_accounts,id|bank_account_owner"},{"name":"amount","validation":"required|numeric"},{"name":"isDuplicated","validation":"required|boolean|in:0"}],"name":"Traspasos"}'
            ],
            [
                'id' => 8,
                'name' => 'Recargas',
            ...
            [
                ...
                'country' => 0,
                'meta_data' => '{"all":[{"name":"account_id","validation":"required|exists:banks_accounts,id|bank_account_owner"},{"name":"amount","validation":"required|numeric"},{"name":"isDuplicated","validation":"required|boolean|in:0"}],"name":"Comisiones"}'
            ],
            [
                'id' => 10,
                'name' => 'Créditos',
            ...
            [
                ...
                'country' => 1,
                'meta_data' => '{"all":[{"name":"transferences_quantity","validation":"required|numeric"},{"name":"amount","validation":"required|numeric"},{"name":"rate","validation":"required|numeric"},{"name":"isDuplicated","validation":"required|boolean|in:0"}],"name":"Cuenta Billetera","type":"2"}'
            ],
            [
                'id' => 13,
                'name' => 'Efectivo',
                ...
                'country' => 1,
                'meta_data' => '{"all":[{"name":"amount","validation":"required|numeric"},{"name":"isDuplicated","validation":"required|boolean|in:0"}],"name":"Efectivo","type":"2"}'
            ],
            [
                'id' => 14,
                'name' => 'Transferencia',
                ...
                'country' => 1,
                'meta_data' => '{"all":[{"name":"account_id","validation":"required|exists:banks_accounts,id|bank_account_owner"},{"name":"amount","validation":"required|numeric"},{"name":"isDuplicated","validation":"required|boolean|in:0"}],"name":"Transferencia","type":"2"}'
            ],
            [
                'id' => 15,
                'name' => 'Ayuda Recibida',
                ...
                'country' => 1,
                'meta_data' => '{"all":[{"name":"store_id","validation":"required|exists:stores,id"},{"name":"amount","validation":"required|numeric"},{"name":"isDuplicated","validation":"required|boolean|in:0"}],"name":"Ayuda","type":"2"}'
            ],
            [
                'id' => 16,
                'name' => 'Traspaso',
                ...
                'country' => 1,
                'meta_data' => '{"all":[{"name":"senderAccount_id","validation":"required|exists:banks_accounts,id|bank_account_owner"},{"name":"receiverAccount_id","validation":"required|exists:banks_accounts,id|bank_account_owner"},{"name":"amount","validation":"required|numeric"},{"name":"isDuplicated","validation":"required|boolean|in:0"}],"name":"Traspaso","type":"2"}'
            ],
            [
                'id' => 17,
            ...
            [
                ...
                'country' => 1,
                'meta_data' => '{"all":[{"name":"account_id","validation":"required|exists:banks_accounts,id|bank_account_owner"},{"name":"amount","validation":"required|numeric"},{"name":"isDuplicated","validation":"required|boolean|in:0"}],"name":"Comisiones","type":2}'
            ],
            [
                'id' => 20,
                'name' => 'Créditos',
            ...
            [
                ...
                'country' => 1,
                'meta_data' => '{"all":[{"name":"transferences_quantity","validation":"required|numeric"},{"name":"currency_id","validation":"required|exists:currencies,id"},{"name":"amount","validation":"required|numeric"},{"name":"rate","validation":"required|numeric"},{"name":"isDuplicated","validation":"required|boolean|in:0"}],"name":"Billetera","type":"1","admin":[{"name":"country_id","validation":"required|exists:countries,id"}],"special":[{"name":"country_id","validation":"required|exists:countries,id"}]}'
            ],
            [
                'id' => 23,
                'name' => 'Giros',
                ...
                'country' => 0,
                'meta_data' => '{"all":[{"name":"bank_id","validation":"required|exists:banks,id"},{"name":"currency_id","validation":"required|numeric"},{"name":"transferences_quantity","validation":"required|numeric"},{"name":"user_id","validation":"required|exists:users,id|user_role:2"},{"name":"amount","validation":"required|numeric"},{"name":"rate","validation":"required|numeric"},{"name":"isDuplicated","validation":"required|boolean|in:0"}],"name":"Giros","type":"1","admin":[{"name":"country_id","validation":"required|exists:countries,id"}],"special":[{"name":"country_id","validation":"required|exists:countries,id"}]}'
            ],
            [
                'id' => 24,
                'name' => 'cuenta billetera',
            ...
            [
                ...
                'country' => 1,
                'meta_data' => '{"all":[{"name":"store_id","validation":"required|exists:stores,id"},{"name":"account_id","validation":"required|exists:banks_accounts,id"},{"name":"amount","validation":"required|numeric"},{"name":"isDuplicated","validation":"required|boolean|in:0"}],"name":"Efectivo Depositante","type":"2"}'
            ],
            [
                'id' => 26,
                'name' => 'Proovedor',
                ...
                'country' => 1,
                'meta_data' => '{"all":[{"name":"user_id","validation":"required|exists:users,id|user_role:2"},{"name":"account_id","validation":"required|exists:banks_accounts,id"},{"name":"amount","validation":"required|numeric"},{"name":"isDuplicated","validation":"required|boolean|in:0"}],"name":"Proovedor","type":3}'
            ],
            [
                'id' => 27,
                'name' => 'Efectivo',
                ...
                'country' => 1,
                'meta_data' => '{"all":[{"name":"amount","validation":"required|numeric"},{"name":"store_id","validation":"required|exists:stores,id"},{"name":"isDuplicated","validation":"required|boolean|in:0"}],"name":"Efectivo depositante","type":4,"user_balance":true}'
            ],
            [
                'id' => 28,
                'name' => 'Billetera',
            ...
            [
                ...
                'country' => 1,
                'meta_data' => '{"all":[{"name":"supplier_id","validation":"required|exists:users,id|user_role:4"},{"name":"amount","validation":"required|numeric"},{"name":"currency_id","validation":"required|exists:currencies,id"},{"name":"deposits_quantity","validation":"required|numeric"},{"name":"isDuplicated","validation":"required|boolean|in:0"}],"name":"Proveedor","type":4,"user_balance":true}'
            ],
            [
                'id' => 30,
                'name' => 'Entrega',
                ...
                'updated_at' => '2024-01-07 07:21:15',
                'country' => 1,
                'meta_data' => '{"all":[{"name":"supplier_id","validation":"required|exists:users,id|user_role:6"},{"name":"amount","validation":"required|numeric"},{"name":"currency_id","validation":"required|exists:currencies,id"},{"name":"isDuplicated","validation":"required|boolean|in:0"}],"name":"Entrega","type":4,"user_balance":true}'
            ],
            [
                'id' => 31,
                'name' => 'Efectivo',
                ...
                'updated_at' => '2024-01-07 07:21:15',
                'country' => 1,
                'meta_data' => '{"all":[{"name":"store_id","validation":"required|exists:stores,id"},{"name":"amount","validation":"required|numeric"},{"name":"currency_id","validation":"required|exists:currencies,id"},{"name":"isDuplicated","validation":"required|boolean|in:0"}],"name":"Efectivo caja fuerte","type":5, "user_balance":true}'
            ],
            [
                'id' => 32,
                'name' => 'Efectivo',
                ...
                'updated_at' => '2024-01-07 07:21:15',
                'country' => 1,
                'meta_data' => '{"all":[{"name":"amount","validation":"required|numeric"},{"name":"store_id","validation":"required|exists:stores,id"},{"name":"isDuplicated","validation":"required|boolean|in:0"},{"name":"deposits_quantity","validation":"required|numeric"},{"name":"currency_id","validation":"required|exists:currencies,id"}],"name":"Efectivo egreso caja fuerte","type":5 ,"user_balance":true}'
            ],
            [
                'id' => 33,
                'name' => 'Entrega',
                ...
                'updated_at' => '2024-01-07 07:21:15',
                'country' => 1,
                'meta_data' => '{"all":[{"name":"supplier_id","validation":"required|exists:users,id|user_role:4"},{"name":"amount","validation":"required|numeric"},{"name":"currency_id","validation":"required|exists:currencies,id"},{"name":"isDuplicated","validation":"required|boolean|in:0"}],"name":"Entrega","type":5 ,"user_balance":true}'
            ],
            [
                'id' => 34,
                'name' => 'Depósitos',
