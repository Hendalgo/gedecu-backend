...
class ReportsTypesSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $reportTypes = [
            ...
            [
                'id' => 27,
                'name' => 'Entrega de local',
                'description' => 'Entrega de local',
                'type' => 'income',
                'config' => '{"styles":{"color":"#055160","borderColor":"#9EEAF9","backgroundColor":"#CFF4FC"}}',
                'delete' => 0,
                ...
                'country' => 1,
                'meta_data' => '{"name":"Entrega de local","type":4,"user_balance":true}',
            ],
            [
                'id' => 28,
                'name' => 'Depósito de Billetera',
                'description' => 'Depósito de Billetera',
                'type' => 'expense',
                'config' => '{"styles":{"color":"#055160","borderColor":"#9EEAF9","backgroundColor":"#CFF4FC"}}',
                'delete' => 0,
                'created_at' => '2024-01-07 07:10:28',
                'updated_at' => '2024-01-07 07:10:28',
                'country' => 1,
                'meta_data' => '{"name":"Depósito de Billetera","type":4,"user_balance":true}',
            ],
            [
                'id' => 29,
                'name' => 'Proveedor',
            ...
            [
                ...
                'updated_at' => '2024-01-07 07:21:15',
                'country' => 1,
                'meta_data' => '{"name":"Entrega a caja","type":4,"user_balance":true}',
            ],
            [
                'id' => 31,
                'name' => 'Efectivo',
